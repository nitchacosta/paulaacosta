...
<body class="d-flex align-items-center justify-content-center p-4">
    <div class="auth-card p-5" style="width: 100%; max-width: 28rem;">
        <h1 class="h2 fw-bold text-dark text-center mb-4">Login Form</h1>
        ...
        <div class="bg-light rounded-pill p-1 mb-4 d-flex">
            ...
            <button onclick="window.location.href='<?= site_url('register'); ?>'" class="toggle-btn inactive flex-fill">
                Signup
            </button>
        </div>
                            <?php getErrors(); ?>
        ...
        <div class="text-center mt-4">
            ...
            <a href="<?= site_url('register'); ?>" class="text-primary text-decoration-none fw-medium">
                Signup now
            </a>
        </div>
    </div>
